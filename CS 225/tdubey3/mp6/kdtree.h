...
class KDTree
{
    ...
    private:
        ...
        int calculateDistance(const Point<Dim> & pointOne, const Point<Dim> & pointTwo) const;

        /* Helper function for constructing a KD Tree with K dimensions
         *
         * @param left Left index to start at
         * @param right Right index (max) to end at
         * @param dim The current dimension being analyzed
         */
        void bobTheBuilder(int left, int right, int dim);

        /*
         * Function the implements Quickselect
         * @param left Min value for quickselect
         * @param right Max value for quickselect
         * @param middle Midpoint for quickselect pivot
         */
        void quickSelect(int left, int right, int dim, int middle);

        /*
         * Helper function for quickselect that partitions the current vector
         * @param left Left index to start at
         * @param right Right index (max) to end at
         * @param dim the current dimension
         * @param middle The median of the vector
         */
        int partitionVector(int left, int right, int dim, int middle);

        /*
         * Helper function for finding the nearest neighbor point in a KD tree
         * @param left Left index to start at
         * @param right Right index (max) to end at
         * @param dim the current dimension
         * @param query The point to find the nearest neighbor to
         * @param currentBest The best canidate found for being the nearest neighbor currently
         */
        Point<Dim> neighborDetector(int left, int right, int dim, const Point<Dim> &query, const Point<Dim> &currentBest) const;

        /*
         * Helper function to swap two indicies in a vector (or array)
         * @param indexOne The first index to swap
         * @param indexOne The second index to swap
         */
        void swapPoints(int indexOne, int indexTwo);
